...
extension Float16: Real {
  ...
  #if canImport(_NumericsShims)
    return _numerics_relaxed_addf16(a, b)
  #else
    // Fallback: conservative addition for Float16 when shim unavailable
    return a + b
  #endif
  }
  ...
  #if canImport(_NumericsShims)
    return _numerics_relaxed_mulf16(a, b)
  #else
    // Fallback: conservative multiplication for Float16 when shim unavailable
    return a * b
  #endif
  }
  #endif
