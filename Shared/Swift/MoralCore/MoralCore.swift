...
public struct MoralCore {
    ...
    private func createMoralEvaluation(_ assessment: MoralAssessment, _ autonomyStatus: AutonomyStatus) -> MoralEvaluation {
        let requestAnalysis: [String: Any] = [
            "type": assessment.assessmentData.requestType,
            "risk_level": assessment.assessmentData.riskLevel,
            "needs_autonomy": assessment.assessmentData.needsAutonomy,
            "complexity": assessment.assessmentData.complexity
        ]
        ...
        let foundationAlignment = assessment.assessmentData.foundationAlignment.reduce(into: [String: Double]()) { result, alignment in
            result[alignment.principle] = alignment.alignmentScore
        }
